...
# runtime settings
train_cfg = dict(_delete_=True, type='IterBasedTrainLoop', max_iters=4000)
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=200, max_keep_ckpts=3, by_epoch=False))
